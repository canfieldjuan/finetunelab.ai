...
export interface LLMModel {
  ...
  lora_config: Record<string, any> | null; // e.g., {r: 8, alpha: 32, dropout: 0.05}
  evaluation_metrics: Record<string, any> | null; // e.g., {accuracy: 0.95, loss: 0.18}

  // Deployment Metadata (for vLLM/Ollama deployments)
  metadata: Record<string, any> | null; // e.g., {training_job_id, server_id, deployed_at, model_path, checkpoint_path}
