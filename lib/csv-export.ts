...
export function exportModelPerformanceToCSV(models: any[]): void {
  const headers = [
    'modelId',
    'modelName',
    'provider',
...
export function exportSessionMetricsToCSV(sessions: any[]): void {
  const headers = [
    'sessionId',
    'experimentName',
    'totalConversations',
...
export function exportTrainingEffectivenessToCSV(training: any[]): void {
  const headers = [
    'trainingMethod',
    'modelCount',
    'totalMessages',
...
export function exportAllAnalyticsToCSV(data: any): void {
  ...
  if (data.modelPerformance && data.modelPerformance.length > 0) {
    ...
    data.modelPerformance.forEach((m: any) => {
      sections.push([
