...
if (typeof window !== 'undefined') {
  (window as any).testVoiceCommands = testVoiceCommands;
  (window as any).testCommandMatch = testCommandMatch;
  (window as any).testMultipleCommands = testMultipleCommands;
