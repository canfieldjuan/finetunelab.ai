...
export type DeploymentPlatform = 'kaggle' | 'runpod' | 'huggingface-spaces' | 'local-vllm' | 'google-colab';

export interface UnifiedDeploymentRequest {
  platform: DeploymentPlatform;
  training_config_id: string;
  config: KaggleDeploymentRequest | RunPodDeploymentRequest | HFSpacesDeploymentRequest;
}
