...
export default function FeaturesPage() {
  ...
  const features = [
    ...
    },
    {
      ...
      description: 'Deploy trained models to production with one click. Local servers (vLLM, Ollama) or cloud (RunPod Serverless) with automatic scaling and budget controls.',
      highlights: [
        'RunPod Serverless with auto-scaling (A4000 to H100 GPUs)',
        'Local deployment (vLLM, Ollama, FastAPI)',
        ...
        <div className="max-w-6xl mx-auto p-8">
          ...
          <section className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {useCases.map((useCase, idx) => (
                <div 
                  key={idx}
                  className="p-6 border border-slate-200 dark:border-slate-800 rounded-lg hover:shadow-lg transition-shadow"
                >
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Choose local deployment (vLLM, Ollama) or cloud (RunPod Serverless with auto-scaling). Set budget limits and get an API endpoint ready for production traffic.
                  </p>
                </div>
              </div>
          ...
          <section className="mb-16">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className="p-4 border border-slate-200 dark:border-slate-800 rounded-lg text-center">
                <p className="font-bold mb-1">vLLM & Ollama</p>
                <p className="text-sm text-muted-foreground">Inference Engines</p>
              </div>
              <div className="p-4 border border-slate-200 dark:border-slate-800 rounded-lg text-center">
