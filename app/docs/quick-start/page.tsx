          ...
          <section className="mb-12">
            ...
            <div className="relative mb-4">
              <div className="absolute top-3 right-3 z-10">
                <button
                  onClick={() => copyToClipboard('curl http://localhost:8000/api/models', 'models')}
  ...
  "message": "Training job started successfully"
          ...
          <section className="mb-12">
            ...
            <div className="relative mb-4">
              <div className="absolute top-3 right-3 z-10">
                <button
                  onClick={() => copyToClipboard('curl http://localhost:8000/api/training/status/job-12345', 'status')}
                  className="p-2 bg-gray-800 hover:bg-gray-700 rounded-md text-white transition-colors"
                  title="Copy code"
                >
                  {copiedCode === 'status' ? (
              ...
              <pre className="bg-gray-900 text-gray-100 p-4 rounded-lg overflow-x-auto">
                <code className="text-sm font-mono">
                  curl http://localhost:8000/api/training/status/job-12345
                </code>
              </pre>
            </div>
...
{`{
  ...
  "loss": 0.234
          ...
          <section className="mb-12">
            ...
            <p className="text-muted-foreground mb-4">
              Once training completes, deploy your model to production with RunPod Serverless or locally with vLLM/Ollama.
            </p>
