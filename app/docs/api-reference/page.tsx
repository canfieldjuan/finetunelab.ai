        ...
        <div className="max-w-4xl mx-auto p-8">
          ...
          <div className="mb-12 p-6 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-950/20 dark:to-indigo-950/20 border border-blue-200 dark:border-blue-800 rounded-lg">
            ...
            <p className="text-sm text-muted-foreground mt-3">
              All endpoints are relative to this base URL. Replace with your production URL when deploying.
            </p>
          </div>
            ...
            <div className="mb-6">
              ...
              <div className="relative">
                <div className="absolute top-3 right-3 z-10">
                  <button
                    onClick={() => copyToClipboard('curl http://localhost:8000/api/models', 'list-models')}
                ...
                <pre className="bg-gray-900 text-gray-100 p-4 rounded-lg overflow-x-auto">
                  <code className="text-sm font-mono">curl http://localhost:8000/api/models</code>
                </pre>
              </div>
            </div>
...
`curl -X POST http://localhost:8000/api/training/start \\
  ...
  -d '{
    ...
    "config": "default"
                ...
                <pre className="bg-gray-900 text-gray-100 p-4 rounded-lg overflow-x-auto">
                  <code className="text-sm font-mono">{`curl -X POST http://localhost:8000/api/training/start \\
  -H "Content-Type: application/json" \\
  -d '{
    "model": "llama-3-8b",
    "dataset": "dataset-abc123",
          ...
          <section id="get-status" className="mb-16 scroll-mt-8">
            ...
            <div className="mb-6">
              ...
              <div className="relative">
                <div className="absolute top-3 right-3 z-10">
                  <button
                    onClick={() => copyToClipboard('curl http://localhost:8000/api/training/status/job-12345-abcde', 'get-status')}
                    className="p-2 bg-gray-800 hover:bg-gray-700 rounded-md text-white transition-colors"
                  >
                ...
                <pre className="bg-gray-900 text-gray-100 p-4 rounded-lg overflow-x-auto">
                  <code className="text-sm font-mono">curl http://localhost:8000/api/training/status/job-12345-abcde</code>
                </pre>
              </div>
            </div>
          ...
          <section id="pause-job" className="mb-16 scroll-mt-8">
            ...
            <div className="mb-6">
              ...
              <div className="relative">
                <div className="absolute top-3 right-3 z-10">
                  <button
                    onClick={() => copyToClipboard('curl -X POST http://localhost:8000/api/training/pause/job-12345-abcde', 'pause-job')}
                    className="p-2 bg-gray-800 hover:bg-gray-700 rounded-md text-white transition-colors"
                  >
                ...
                <pre className="bg-gray-900 text-gray-100 p-4 rounded-lg overflow-x-auto">
                  <code className="text-sm font-mono">curl -X POST http://localhost:8000/api/training/pause/job-12345-abcde</code>
                </pre>
              </div>
            </div>
          ...
          <section id="resume-job" className="mb-16 scroll-mt-8">
            ...
            <div className="mb-6">
              ...
              <div className="relative">
                <div className="absolute top-3 right-3 z-10">
                  <button
                    onClick={() => copyToClipboard('curl -X POST http://localhost:8000/api/training/resume/job-12345-abcde', 'resume-job')}
                    className="p-2 bg-gray-800 hover:bg-gray-700 rounded-md text-white transition-colors"
                  >
                ...
                <pre className="bg-gray-900 text-gray-100 p-4 rounded-lg overflow-x-auto">
                  <code className="text-sm font-mono">curl -X POST http://localhost:8000/api/training/resume/job-12345-abcde</code>
                </pre>
              </div>
            </div>
          ...
          <section id="cancel-job" className="mb-16 scroll-mt-8">
            ...
            <div className="mb-6">
              ...
              <div className="relative">
                <div className="absolute top-3 right-3 z-10">
                  <button
                    onClick={() => copyToClipboard('curl -X POST http://localhost:8000/api/training/cancel/job-12345-abcde', 'cancel-job')}
                    className="p-2 bg-gray-800 hover:bg-gray-700 rounded-md text-white transition-colors"
                  >
                ...
                <pre className="bg-gray-900 text-gray-100 p-4 rounded-lg overflow-x-auto">
                  <code className="text-sm font-mono">curl -X POST http://localhost:8000/api/training/cancel/job-12345-abcde</code>
                </pre>
              </div>
            </div>
          ...
          <section id="list-datasets" className="mb-16 scroll-mt-8">
            ...
            <div className="mb-6">
              ...
              <div className="relative">
                <div className="absolute top-3 right-3 z-10">
                  <button
                    onClick={() => copyToClipboard('curl http://localhost:8000/api/training/dataset', 'list-datasets')}
                    className="p-2 bg-gray-800 hover:bg-gray-700 rounded-md text-white transition-colors"
                  >
                ...
                <pre className="bg-gray-900 text-gray-100 p-4 rounded-lg overflow-x-auto">
                  <code className="text-sm font-mono">curl http://localhost:8000/api/training/dataset</code>
                </pre>
              </div>
            </div>
      ...
      "created_at": "2025-11-05T14:20:00Z"
          ...
          <section id="deploy-model" className="mb-16 scroll-mt-8">
            ...
            <div className="mb-6 p-4 bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800 rounded-lg">
              <h3 className="font-semibold mb-2">� What this does:</h3>
              <p className="text-sm text-muted-foreground">
                Deploys a completed training job to a local vLLM server for inference. Makes the model available for real-time predictions.
              </p>
            </div>
            ...
            <div className="mb-6">
              ...
              <div className="space-y-3 mb-4">
                ...
                <div className="p-3 bg-muted rounded-md">
                  <code className="font-mono text-sm">port</code>
                  <span className="text-muted-foreground text-sm ml-2">number</span>
                  <p className="text-sm text-muted-foreground mt-1">vLLM server port (default: 8001)</p>
                </div>
              </div>
              ...
              <div className="relative">
                <div className="absolute top-3 right-3 z-10">
                  <button
                    onClick={() => copyToClipboard(
`curl -X POST http://localhost:8000/api/training/deploy \\
  -H "Content-Type: application/json" \\
  -d '{
    "job_id": "job-12345-abcde",
    ...
    "port": 8001
                ...
                <pre className="bg-gray-900 text-gray-100 p-4 rounded-lg overflow-x-auto">
                  <code className="text-sm font-mono">{`curl -X POST http://localhost:8000/api/training/deploy \\
  -H "Content-Type: application/json" \\
  -d '{
    "job_id": "job-12345-abcde",
    "checkpoint": "checkpoint-final",
        ...
        "learning_rate": 2e-5
              ...
              <div className="bg-slate-900 dark:bg-slate-950 p-4 rounded-lg overflow-x-auto">
                <pre className="text-sm text-slate-100">
                  <code className="text-sm font-mono">{`curl -X POST http://localhost:8000/api/training/execute \\
  -H "Content-Type: application/json" \\
  -d '{
    "execution_id": "exec-123",
    "name": "My Training Job",
          ...
          <section id="get-metrics" className="mb-16 scroll-mt-8">
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-2">
                ...
                <button
                  onClick={() => copyToClipboard('curl http://localhost:8000/api/training/metrics/job-12345-abcde', 'get-metrics')}
                  className="text-sm text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 flex items-center gap-1"
                >
              ...
              <div className="bg-slate-900 dark:bg-slate-950 p-4 rounded-lg overflow-x-auto">
                <pre className="text-sm text-slate-100">
                  <code className="text-sm font-mono">curl http://localhost:8000/api/training/metrics/job-12345-abcde</code>
                </pre>
              </div>
            </div>
          ...
          <section id="get-logs" className="mb-16 scroll-mt-8">
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-2">
                <h3 className="text-lg font-semibold">Request:</h3>
                <button
                  onClick={() => copyToClipboard('curl http://localhost:8000/api/training/logs/job-12345-abcde', 'get-logs')}
                  className="text-sm text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 flex items-center gap-1"
                >
              ...
              <div className="bg-slate-900 dark:bg-slate-950 p-4 rounded-lg overflow-x-auto">
                <pre className="text-sm text-slate-100">
                  <code className="text-sm font-mono">curl http://localhost:8000/api/training/logs/job-12345-abcde</code>
                </pre>
              </div>
            </div>
          ...
          <section id="list-checkpoints" className="mb-16 scroll-mt-8">
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-2">
                <h3 className="text-lg font-semibold">Request:</h3>
                <button
                  onClick={() => copyToClipboard('curl http://localhost:8000/api/training/checkpoints/job-12345-abcde', 'list-checkpoints')}
                  className="text-sm text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 flex items-center gap-1"
                >
              ...
              <div className="bg-slate-900 dark:bg-slate-950 p-4 rounded-lg overflow-x-auto">
                <pre className="text-sm text-slate-100">
                  <code className="text-sm font-mono">curl http://localhost:8000/api/training/checkpoints/job-12345-abcde</code>
                </pre>
              </div>
            </div>
          ...
          <section id="validate-model" className="mb-16 scroll-mt-8">
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-2">
                ...
                <button
                  onClick={() => copyToClipboard(
`curl -X POST http://localhost:8000/api/training/validate \\
  -H "Content-Type: application/json" \\
  -d '{
    ...
    "metrics_to_compute": ["perplexity", "accuracy", "bleu"]
              ...
              <div className="bg-slate-900 dark:bg-slate-950 p-4 rounded-lg overflow-x-auto">
                <pre className="text-sm text-slate-100">
                  <code className="text-sm font-mono">{`curl -X POST http://localhost:8000/api/training/validate \\
  -H "Content-Type: application/json" \\
  -d '{
    "model_path": "/models/checkpoint-2000",
    "test_dataset_id": "test-dataset-001",
          ...
          <section id="download-model" className="mb-16 scroll-mt-8">
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-2">
                ...
                <button
                  onClick={() => copyToClipboard('curl http://localhost:8000/api/training/job-12345-abcde/download/model?checkpoint=checkpoint-2000', 'download-model')}
                  className="text-sm text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 flex items-center gap-1"
                >
              ...
              <div className="bg-slate-900 dark:bg-slate-950 p-4 rounded-lg overflow-x-auto">
                <pre className="text-sm text-slate-100">
                  <code className="text-sm font-mono">curl http://localhost:8000/api/training/job-12345-abcde/download/model?checkpoint=checkpoint-2000 -O</code>
                </pre>
              </div>
            </div>
          ...
          <section id="download-logs" className="mb-16 scroll-mt-8">
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-2">
                <h3 className="text-lg font-semibold">Request:</h3>
                <button
                  onClick={() => copyToClipboard('curl http://localhost:8000/api/training/job-12345-abcde/download/logs -O', 'download-logs')}
                  className="text-sm text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 flex items-center gap-1"
                >
              ...
              <div className="bg-slate-900 dark:bg-slate-950 p-4 rounded-lg overflow-x-auto">
                <pre className="text-sm text-slate-100">
                  <code className="text-sm font-mono">curl http://localhost:8000/api/training/job-12345-abcde/download/logs -O</code>
                </pre>
              </div>
            </div>
          ...
          <section id="job-analytics" className="mb-16 scroll-mt-8">
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-2">
                <h3 className="text-lg font-semibold">Request:</h3>
                <button
                  onClick={() => copyToClipboard('curl http://localhost:8000/api/training/job-12345-abcde/analytics', 'job-analytics')}
                  className="text-sm text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 flex items-center gap-1"
                >
              ...
              <div className="bg-slate-900 dark:bg-slate-950 p-4 rounded-lg overflow-x-auto">
                <pre className="text-sm text-slate-100">
                  <code className="text-sm font-mono">curl http://localhost:8000/api/training/job-12345-abcde/analytics</code>
                </pre>
              </div>
            </div>
          ...
          <section id="analytics-summary" className="mb-16 scroll-mt-8">
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-2">
                <h3 className="text-lg font-semibold">Request:</h3>
                <button
                  onClick={() => copyToClipboard('curl http://localhost:8000/api/training/analytics/summary', 'analytics-summary')}
                  className="text-sm text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 flex items-center gap-1"
                >
              ...
              <div className="bg-slate-900 dark:bg-slate-950 p-4 rounded-lg overflow-x-auto">
                <pre className="text-sm text-slate-100">
                  <code className="text-sm font-mono">curl http://localhost:8000/api/training/analytics/summary</code>
                </pre>
              </div>
            </div>
          ...
          <section id="analytics-compare" className="mb-16 scroll-mt-8">
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-2">
                <h3 className="text-lg font-semibold">Request:</h3>
                <button
                  onClick={() => copyToClipboard('curl "http://localhost:8000/api/training/analytics/compare?job_ids=job-123,job-456,job-789"', 'analytics-compare')}
                  className="text-sm text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 flex items-center gap-1"
                >
              ...
              <div className="bg-slate-900 dark:bg-slate-950 p-4 rounded-lg overflow-x-auto">
                <pre className="text-sm text-slate-100">
                  <code className="text-sm font-mono">curl &quot;http://localhost:8000/api/training/analytics/compare?job_ids=job-123,job-456,job-789&quot;</code>
                </pre>
              </div>
            </div>
          ...
          <section id="list-configs" className="mb-16 scroll-mt-8">
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-2">
                <h3 className="text-lg font-semibold">Request:</h3>
                <button
                  onClick={() => copyToClipboard('curl http://localhost:3000/api/training -H "Authorization: Bearer YOUR_TOKEN"', 'list-configs')}
                  className="text-sm text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 flex items-center gap-1"
                >
              ...
              <div className="bg-slate-900 dark:bg-slate-950 p-4 rounded-lg overflow-x-auto">
                <pre className="text-sm text-slate-100">
                  <code className="text-sm font-mono">curl http://localhost:3000/api/training -H &quot;Authorization: Bearer YOUR_TOKEN&quot;</code>
                </pre>
              </div>
            </div>
    ...
    "config_json": {
      ...
      "training": {
        ...
        "learning_rate": 2e-5
              ...
              <div className="bg-slate-900 dark:bg-slate-950 p-4 rounded-lg overflow-x-auto">
                <pre className="text-sm text-slate-100">
                  <code className="text-sm font-mono">{`curl -X POST http://localhost:3000/api/training \\
  -H "Authorization: Bearer YOUR_TOKEN" \\
  -H "Content-Type: application/json" \\
          ...
          <section id="get-config" className="mb-16 scroll-mt-8">
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-2">
                <h3 className="text-lg font-semibold">Request:</h3>
                <button
                  onClick={() => copyToClipboard('curl http://localhost:3000/api/training/config-123 -H "Authorization: Bearer YOUR_TOKEN"', 'get-config')}
                  className="text-sm text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 flex items-center gap-1"
                >
              ...
              <div className="bg-slate-900 dark:bg-slate-950 p-4 rounded-lg overflow-x-auto">
                <pre className="text-sm text-slate-100">
                  <code className="text-sm font-mono">curl http://localhost:3000/api/training/config-123 -H &quot;Authorization: Bearer YOUR_TOKEN&quot;</code>
                </pre>
              </div>
            </div>
          ...
          <section id="update-config" className="mb-16 scroll-mt-8">
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-2">
                ...
                <button
                  onClick={() => copyToClipboard(
`curl -X PUT http://localhost:3000/api/training/config-123 \\
  -H "Authorization: Bearer YOUR_TOKEN" \\
  -H "Content-Type: application/json" \\
  -d '{
    ...
    "config_json": {
      "training": {
        ...
        "learning_rate": 1e-5
              ...
              <div className="bg-slate-900 dark:bg-slate-950 p-4 rounded-lg overflow-x-auto">
                <pre className="text-sm text-slate-100">
                  <code className="text-sm font-mono">{`curl -X PUT http://localhost:3000/api/training/config-123 \\
  -H "Authorization: Bearer YOUR_TOKEN" \\
          ...
          <section id="delete-config" className="mb-16 scroll-mt-8">
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-2">
                <h3 className="text-lg font-semibold">Request:</h3>
                <button
                  onClick={() => copyToClipboard('curl -X DELETE http://localhost:3000/api/training/config-123 -H "Authorization: Bearer YOUR_TOKEN"', 'delete-config')}
                  className="text-sm text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 flex items-center gap-1"
                >
              ...
              <div className="bg-slate-900 dark:bg-slate-950 p-4 rounded-lg overflow-x-auto">
                <pre className="text-sm text-slate-100">
                  <code className="text-sm font-mono">curl -X DELETE http://localhost:3000/api/training/config-123 -H &quot;Authorization: Bearer YOUR_TOKEN&quot;</code>
                </pre>
              </div>
            </div>
...
`curl -X POST http://localhost:3000/api/models \\
  ...
  -d '{
    ...
    "default_temperature": 0.7
              ...
              <div className="bg-slate-900 dark:bg-slate-950 p-4 rounded-lg overflow-x-auto">
                <pre className="text-sm text-slate-100">
                  <code className="text-sm font-mono">{`curl -X POST http://localhost:3000/api/models \\
  -H "Authorization: Bearer YOUR_TOKEN" \\
  -d '{
    "name": "My Custom GPT-4",
    "provider": "openai",
          ...
          <section id="delete-model" className="mb-16 scroll-mt-8">
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-2">
                <h3 className="text-lg font-semibold">Request:</h3>
                <button
                  onClick={() => copyToClipboard('curl -X DELETE http://localhost:3000/api/models/model-789 -H "Authorization: Bearer YOUR_TOKEN"', 'delete-model')}
                  className="text-sm text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 flex items-center gap-1"
                >
              ...
              <div className="bg-slate-900 dark:bg-slate-950 p-4 rounded-lg overflow-x-auto">
                <pre className="text-sm text-slate-100">
                  <code className="text-sm font-mono">curl -X DELETE http://localhost:3000/api/models/model-789 -H &quot;Authorization: Bearer YOUR_TOKEN&quot;</code>
                </pre>
              </div>
            </div>
          ...
          <section id="deploy-inference" className="mb-16 scroll-mt-8">
            ...
            <div className="mb-6">
              ...
              <div className="relative">
                <div className="absolute top-3 right-3 z-10">
                  <button
                    onClick={() => copyToClipboard(`curl -X POST http://localhost:8000/api/inference/deploy \\
  -H "Content-Type: application/json" \\
  ...
  -d '{
    ...
    "auto_stop_on_budget": true
                ...
                <pre className="bg-gray-900 text-gray-100 p-4 rounded-lg overflow-x-auto text-sm">
                  <code className="font-mono">{`curl -X POST http://localhost:8000/api/inference/deploy \\
  -H "Content-Type: application/json" \\
  -H "Authorization: Bearer YOUR_ACCESS_TOKEN" \\
  -d '{
    "provider": "runpod-serverless",
          ...
          <section id="inference-status" className="mb-16 scroll-mt-8">
            ...
            <div className="mb-6">
              ...
              <div className="relative">
                <div className="absolute top-3 right-3 z-10">
                  <button
                    onClick={() => copyToClipboard(`curl http://localhost:8000/api/inference/deployments/dep-xyz789/status \\
  -H "Authorization: Bearer YOUR_ACCESS_TOKEN"`, 'inference-status')}
                ...
                <pre className="bg-gray-900 text-gray-100 p-4 rounded-lg overflow-x-auto text-sm">
                  <code className="font-mono">{`curl http://localhost:8000/api/inference/deployments/dep-xyz789/status \\
          ...
          <section id="stop-inference" className="mb-16 scroll-mt-8">
            ...
            <div className="mb-6">
              ...
              <div className="relative">
                <div className="absolute top-3 right-3 z-10">
                  <button
                    onClick={() => copyToClipboard(`curl -X DELETE http://localhost:8000/api/inference/deployments/dep-xyz789/stop \\
  -H "Authorization: Bearer YOUR_ACCESS_TOKEN"`, 'stop-inference')}
                ...
                <pre className="bg-gray-900 text-gray-100 p-4 rounded-lg overflow-x-auto text-sm">
                  <code className="font-mono">{`curl -X DELETE http://localhost:8000/api/inference/deployments/dep-xyz789/stop \\
  -H "Authorization: Bearer YOUR_ACCESS_TOKEN"`}</code>
                </pre>
              </div>
            </div>
...
`curl -X POST http://localhost:3000/api/graphrag/upload \\
  ...
  -F 'metadata={"title":"My Document","source":"research"}'`,
              ...
              <div className="bg-slate-900 dark:bg-slate-950 p-4 rounded-lg overflow-x-auto">
                <pre className="text-sm text-slate-100">
                  <code className="text-sm font-mono">{`curl -X POST http://localhost:3000/api/graphrag/upload \\
  -H "Authorization: Bearer YOUR_TOKEN" \\
  -F "file=@document.pdf" \\
          ...
          <section id="list-documents" className="mb-16 scroll-mt-8">
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-2">
                <h3 className="text-lg font-semibold">Request:</h3>
                <button
                  onClick={() => copyToClipboard('curl -X GET http://localhost:3000/api/graphrag/documents -H "Authorization: Bearer YOUR_TOKEN"', 'list-docs')}
                  className="text-sm text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 flex items-center gap-1"
                >
              ...
              <div className="bg-slate-900 dark:bg-slate-950 p-4 rounded-lg overflow-x-auto">
                <pre className="text-sm text-slate-100">
                  <code className="text-sm font-mono">curl -X GET http://localhost:3000/api/graphrag/documents -H &quot;Authorization: Bearer YOUR_TOKEN&quot;</code>
                </pre>
              </div>
            </div>
...
`curl -X POST http://localhost:3000/api/graphrag/search \\
  ...
  -d '{"query":"quantum computing applications","limit":5}'`,
              ...
              <div className="bg-slate-900 dark:bg-slate-950 p-4 rounded-lg overflow-x-auto">
                <pre className="text-sm text-slate-100">
                  <code className="text-sm font-mono">{`curl -X POST http://localhost:3000/api/graphrag/search \\
  -H "Authorization: Bearer YOUR_TOKEN" \\
  -H "Content-Type: application/json" \\
          ...
          <section id="delete-document" className="mb-16 scroll-mt-8">
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-2">
                <h3 className="text-lg font-semibold">Request:</h3>
                <button
                  onClick={() => copyToClipboard('curl -X DELETE http://localhost:3000/api/graphrag/delete/doc-abc-123 -H "Authorization: Bearer YOUR_TOKEN"', 'delete-doc')}
                  className="text-sm text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 flex items-center gap-1"
                >
              ...
              <div className="bg-slate-900 dark:bg-slate-950 p-4 rounded-lg overflow-x-auto">
                <pre className="text-sm text-slate-100">
                  <code className="text-sm font-mono">curl -X DELETE http://localhost:3000/api/graphrag/delete/doc-abc-123 -H &quot;Authorization: Bearer YOUR_TOKEN&quot;</code>
                </pre>
              </div>
            </div>
...
granularity: String (optional) - Data aggregation period
  Values: hour, day (default), week, month, all`}
            ...
            <div className="mb-6">
              ...
              <div className="relative group">
                <button
                  onClick={() => copyToClipboard(`curl -X GET 'http://localhost:8000/api/analytics/data?startDate=2025-11-01T00:00:00Z&endDate=2025-11-12T23:59:59Z&metrics=tokens,quality,tools&granularity=day' \\
  -H "Authorization: Bearer YOUR_TOKEN"`, 'analytics-data-curl')}
                ...
                <pre className="bg-slate-100 dark:bg-slate-900 p-4 rounded-lg pr-14 text-sm overflow-x-auto">
                  {`curl -X GET 'http://localhost:8000/api/analytics/data?startDate=2025-11-01T00:00:00Z&endDate=2025-11-12T23:59:59Z&metrics=tokens,quality,tools&granularity=day' \\
  -H "Authorization: Bearer YOUR_TOKEN"`}
                </pre>
              </div>
            </div>
...
8. training_control - List configs, attach datasets, start training`}
  ...
  "conversationIds": ["conv-1", "conv-2", "conv-3"]
            ...
            <div className="mb-6">
              ...
              <div className="relative group">
                <button
                  onClick={() => copyToClipboard(`curl -X POST http://localhost:8000/api/analytics/chat \\
  -H "Content-Type: application/json" \\
  -H "Authorization: Bearer YOUR_TOKEN" \\
  -d '{
    ...
    "conversationIds": ["conv-1", "conv-2"]
                ...
                <pre className="bg-slate-100 dark:bg-slate-900 p-4 rounded-lg pr-14 text-sm overflow-x-auto">
                  {`curl -X POST http://localhost:8000/api/analytics/chat \\
  -H "Content-Type: application/json" \\
  -H "Authorization: Bearer YOUR_TOKEN" \\
  -d '{
    "messages": [{"role": "user", "content": "Analyze my session costs"}],
...
• error: Error message if failed`}
            ...
            <div className="mb-6">
              ...
              <div className="relative group">
                <button
                  onClick={() => copyToClipboard(`curl -X GET http://localhost:8000/api/training/local/job-abc-123/status \\
  -H "Authorization: Bearer YOUR_TOKEN"`, 'training-status-curl')}
                ...
                <pre className="bg-slate-100 dark:bg-slate-900 p-4 rounded-lg pr-14 text-sm overflow-x-auto">
                  {`curl -X GET http://localhost:8000/api/training/local/job-abc-123/status \\
  -H "Authorization: Bearer YOUR_TOKEN"`}
                </pre>
              </div>
            </div>
...
• Timestamps: created_at (when metric was recorded)`}
            ...
            <div className="mb-6">
              ...
              <div className="relative group">
                <button
                  onClick={() => copyToClipboard(`curl -X GET http://localhost:8000/api/training/local/job-abc-123/metrics \\
  -H "Authorization: Bearer YOUR_TOKEN"`, 'training-metrics-curl')}
                ...
                <pre className="bg-slate-100 dark:bg-slate-900 p-4 rounded-lg pr-14 text-sm overflow-x-auto">
                  {`curl -X GET http://localhost:8000/api/training/local/job-abc-123/metrics \\
  -H "Authorization: Bearer YOUR_TOKEN"`}
                </pre>
              </div>
            </div>
  ...
  - Example: lookback_days=7 for weekly insights`}
            ...
            <div className="mb-6">
              ...
              <div className="relative group">
                <button
                  onClick={() => copyToClipboard(`curl -X GET 'http://localhost:8000/api/analytics/sentiment/insights?lookback_days=14' \\
  -H "Authorization: Bearer YOUR_TOKEN"`, 'sentiment-insights-curl')}
                ...
                <pre className="bg-slate-100 dark:bg-slate-900 p-4 rounded-lg pr-14 text-sm overflow-x-auto">
                  {`curl -X GET 'http://localhost:8000/api/analytics/sentiment/insights?lookback_days=14' \\
  -H "Authorization: Bearer YOUR_TOKEN"`}
                </pre>
              </div>
            </div>
...
• custom: Advanced custom criteria and rules`}
            ...
            <div className="mb-6">
              ...
              <div className="relative group">
                <button
                  onClick={() => copyToClipboard(`curl -X GET 'http://localhost:8000/api/analytics/cohorts?cohort_type=dynamic&is_active=true&limit=20' \\
  -H "Authorization: Bearer YOUR_TOKEN"`, 'cohorts-get-curl')}
                ...
                <pre className="bg-slate-100 dark:bg-slate-900 p-4 rounded-lg pr-14 text-sm overflow-x-auto">
                  {`curl -X GET 'http://localhost:8000/api/analytics/cohorts?cohort_type=dynamic&is_active=true&limit=20' \\
  -H "Authorization: Bearer YOUR_TOKEN"`}
                </pre>
              </div>
            </div>
            ...
            <div className="mb-6">
              ...
              <div className="relative group">
                <button
                  onClick={() => copyToClipboard(`curl -X POST http://localhost:8000/api/analytics/cohorts \\
  -H "Content-Type: application/json" \\
  -H "Authorization: Bearer YOUR_TOKEN" \\
  -d '{
    "name": "Power Users",
    ...
    "criteria": {
      ...
      "active_status": true
            ...
            <div className="mb-6">
              ...
              <div className="relative group">
                <button
                  onClick={() => copyToClipboard(`curl -X PATCH http://localhost:8000/api/analytics/cohorts \\
  -H "Content-Type: application/json" \\
  -H "Authorization: Bearer YOUR_TOKEN" \\
  -d '{
    ...
    "is_active": false
                ...
                <pre className="bg-slate-100 dark:bg-slate-900 p-4 rounded-lg pr-14 text-sm overflow-x-auto">
                  {`curl -X PATCH http://localhost:8000/api/analytics/cohorts \\
  -H "Content-Type: application/json" \\
  -H "Authorization: Bearer YOUR_TOKEN" \\
  -d '{
    "cohort_id": "cohort-abc-123",
    "is_active": false
            ...
            <div className="mb-6">
              ...
              <div className="relative group">
                <button
                  onClick={() => copyToClipboard(`curl -X DELETE 'http://localhost:8000/api/analytics/cohorts?cohort_id=cohort-abc-123' \\
  -H "Authorization: Bearer YOUR_TOKEN"`, 'cohorts-delete-curl')}
                ...
                <pre className="bg-slate-100 dark:bg-slate-900 p-4 rounded-lg pr-14 text-sm overflow-x-auto">
                  {`curl -X DELETE 'http://localhost:8000/api/analytics/cohorts?cohort_id=cohort-abc-123' \\
  -H "Authorization: Bearer YOUR_TOKEN"`}
                </pre>
              </div>
            </div>
