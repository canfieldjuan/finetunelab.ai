...
// Usage
const client = new TrainingClient('http://localhost:3000', 'your-token');
...
export function useTraining(jobId) {
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="p-4 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg">
                  ...
                  <div className="bg-slate-900 dark:bg-slate-950 p-3 rounded text-xs overflow-x-auto">
                    <code className="text-slate-100">{`curl -X POST http://localhost:3000/api/training \\
  ...
  -d '{"name": "my-model", "base_model": "meta-llama/Llama-3.2-1B", "dataset_id": "dataset-123", "epochs": 3}'`}</code>
                ...
                <div className="p-4 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg">
                  ...
                  <div className="bg-slate-900 dark:bg-slate-950 p-3 rounded text-xs overflow-x-auto">
                    <code className="text-slate-100">{`curl -X POST http://localhost:3000/api/training/execute \\
  -H "Content-Type: application/json" \\
  -d '{"id": "config-456"}'`}</code>
                ...
                <div className="p-4 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg">
                  ...
                  <div className="bg-slate-900 dark:bg-slate-950 p-3 rounded text-xs overflow-x-auto">
                    <code className="text-slate-100">{`curl http://localhost:3000/api/training/status/job-789`}</code>
                  </div>
                </div>
                ...
                <div className="p-4 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg">
                  ...
                  <div className="bg-slate-900 dark:bg-slate-950 p-3 rounded text-xs overflow-x-auto">
                    <code className="text-slate-100">{`curl http://localhost:3000/api/training/metrics/job-789`}</code>
                  </div>
                </div>
                ...
                <div className="p-4 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg">
                  ...
                  <div className="bg-slate-900 dark:bg-slate-950 p-3 rounded text-xs overflow-x-auto">
                    <code className="text-slate-100">{`curl -X POST http://localhost:3000/api/training/pause/job-789`}</code>
                  </div>
                </div>
                ...
                <div className="p-4 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg">
                  ...
                  <div className="bg-slate-900 dark:bg-slate-950 p-3 rounded text-xs overflow-x-auto">
                    <code className="text-slate-100">{`curl -X POST http://localhost:3000/api/training/resume/job-789`}</code>
                  </div>
                </div>
                ...
                <div className="p-4 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg">
                  ...
                  <div className="bg-slate-900 dark:bg-slate-950 p-3 rounded text-xs overflow-x-auto">
                    <code className="text-slate-100">{`curl -O http://localhost:3000/api/training/download/job-789`}</code>
                  </div>
                </div>
                ...
                <div className="p-4 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg">
                  ...
                  <div className="bg-slate-900 dark:bg-slate-950 p-3 rounded text-xs overflow-x-auto">
                    <code className="text-slate-100">{`curl http://localhost:3000/api/training/analytics/job-789`}</code>
                  </div>
                </div>
              </div>
            </div>
...
// Example Usage
async function main() {
  const client = new InferenceClient('http://localhost:3000', 'your-token');
...
main().catch(console.error);`,
            ...
            <div className="mb-12">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="p-4 bg-orange-50 dark:bg-orange-950/20 border border-orange-200 dark:border-orange-800 rounded-lg">
                  ...
                  <div className="bg-slate-900 dark:bg-slate-950 p-3 rounded text-xs overflow-x-auto">
                    <code className="text-slate-100">{`curl -X POST http://localhost:3000/api/inference/deploy \\
  ...
  http://localhost:3000/api/inference/deployments/dep-xyz789/status \\
  ...
  http://localhost:3000/api/inference/deployments/dep-xyz789/stop \\
  -H "Authorization: Bearer YOUR_TOKEN"`}</code>
                  </div>
                </div>
              </div>
              ...
              <div className="p-6 bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-950/20 dark:to-emerald-950/20 border border-green-200 dark:border-green-800 rounded-lg">
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="font-semibold">Deploy to vLLM server</p>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <code className="text-xs bg-slate-900 text-slate-100 px-2 py-1 rounded mt-1 block">{`curl -X POST http://localhost:8000/v1/chat/completions -d '{"model": "...", "messages": [...]}'`}</code>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
