...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const webhook = await alertService.createWebhook(user.id, {
      ...
      alert_scheduled_eval_completed: body.alert_scheduled_eval_completed ?? false,
      alert_scheduled_eval_failed: body.alert_scheduled_eval_failed ?? true,
      alert_scheduled_eval_disabled: body.alert_scheduled_eval_disabled ?? true,
      alert_scheduled_eval_regression: body.alert_scheduled_eval_regression ?? true,
