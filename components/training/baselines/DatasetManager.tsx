...
export function DatasetManager({ sessionToken, configId }: DatasetManagerProps) {
  ...
  const [format, setFormat] = useState<'chatml' | 'sharegpt' | 'jsonl' | 'dpo' | 'rlhf' | 'alpaca' | 'openorca' | 'unnatural'>('chatml');
        ...
        {showUploadForm && (
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Select value={format} onValueChange={(v: any) => setFormat(v)} disabled={uploading}>
