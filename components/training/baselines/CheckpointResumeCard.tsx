...
export function CheckpointResumeCard({ jobId, jobStatus, onResumeSuccess }: CheckpointResumeCardProps) {
  ...
  const [jobConfig, setJobConfig] = useState<any>(null);  // Store job config for manual editing
    ...
    return (
      <div className="p-6 bg-gray-50 border border-gray-200 rounded-lg">
        <div className="text-center text-gray-600">
          ...
          <p className="text-sm mt-1">This job did not save any checkpoints before {jobStatus === 'failed' ? 'failing' : 'being cancelled'}.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden">
      <div className="px-6 py-4 bg-amber-50 border-b border-amber-200">
        <h3 className="text-lg font-semibold text-gray-900">Resume Training</h3>
        <p className="text-sm text-gray-600 mt-1">
          This job {jobStatus === 'failed' ? 'failed' : 'was cancelled'}. You can resume from a checkpoint.
        </p>
      </div>
      ...
      <div className="p-6 space-y-4">
        ...
        {resumeMode === 'adjust' && jobConfig && (
          <div className="p-4 bg-blue-50 border border-blue-200 rounded-md space-y-3">
            ...
            <div className="space-y-3">
              ...
              {(() => {
                const trainingConfig = jobConfig?.training || {};
        ...
        >
          {loading ? 'Resuming Training...' : 'Resume Training'}
        </button>
      </div>
    </div>
  );
