...
export interface Step2ConfigData {
  trainingConfig: any; // Will be TrainingConfig from lib/training/training-config.types
  templateType?: string;
...
export interface PackageVersion {
  ...
  // Snapshots
  configSnapshot: any;            // Full config at this version
...
export type WorkflowAction =
  ...
  | { type: 'UPDATE_STEP_DATA'; stepId: StepId; data: any }
