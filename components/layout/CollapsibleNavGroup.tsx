  ...
  return (
    <div className="mb-2">
      ...
      <button
        ...
        className={`w-full text-left px-0 py-2 text-xs font-semibold text-muted-foreground uppercase tracking-wide rounded-md flex items-center justify-between transition-colors ${
