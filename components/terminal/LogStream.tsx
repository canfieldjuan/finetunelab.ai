  ...
  return (
    ...
    >
      {recentLogs.map((log, index) => {
        ...
        return (
          <div key={index} className="flex items-start gap-2 text-gray-300 hover:bg-gray-800 px-1">
            {showTimestamps && (
            ...
            {showLevels && (
              <span className={`${levelColor} shrink-0 w-12 uppercase text-xs font-semibold`}>
