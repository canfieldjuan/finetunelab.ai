...
export function FilterPanel({
  ...
  // Calculate active filter count (exclude settings)
      ...
      <CardContent>
        <div className="space-y-6">
          ...
          {availableModels.length > 0 && (
            <div>
              <label className="text-sm font-semibold mb-2 block">Models ({availableModels.length})</label>
          ...
          {availableSessions.length > 0 && (
            <div>
              <label className="text-sm font-semibold mb-2 block">Sessions ({availableSessions.length})</label>
              <div className="max-h-48 overflow-y-auto space-y-2 border rounded p-2">
