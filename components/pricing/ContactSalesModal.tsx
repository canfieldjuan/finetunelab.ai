...
export function ContactSalesModal({ isOpen, onClose }: ContactSalesModalProps) {
  ...
  const handleEmailContact = () => {
    window.location.href = 'mailto:sales@finetunelab.ai?subject=Enterprise Plan Inquiry';
  };

  const handleScheduleCall = () => {
    // TODO: Replace with your Calendly link or calendar booking system
